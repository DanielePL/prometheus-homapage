...
const tabs = [
  ...
  },
  {
    ...
    description: 'Science-grade velocity tracking via phone camera — no hardware, no Bluetooth, no competition. On-device computer vision at zero cloud cost.',
    features: [
      { icon: ScanLine, text: 'Real-time computer vision barbell tracking — YOLO + MediaPipe on-device' },
      { icon: Gauge, text: '0.99 confidence rating, 7 FPS on mobile CPU-only' },
      { icon: TrendingUp, text: 'Load-Velocity Profiles, velocity trends, e1RM estimation & R² analysis' },
      { icon: Wifi, text: 'No external hardware — just your phone camera, zero cloud cost per session' },
    ],
    mockup: 'laptop',
